...
while (have_posts()):
	...
	$bedrooms = reco_project_field('reco_sale_bedrooms', $post_id, '');
	$bathrooms = reco_project_field('reco_sale_bathrooms', $post_id, '');
	...
	/* Price display */
	$transaction = reco_project_field('reco_sale_transaction', $post_id, 'mua-ban');
	...
	<article class="reco-sale-single" id="main-content">
		...
		<?php reco_render_sale_search_form( '120px', '0' ); ?>
			...
			<div class="reco-container reco-sale-layout__grid">
				...
				<div class="reco-sale-content">
					...
					<div class="reco-sale-header">
						<h1><?php the_title(); ?></h1>
						<?php if ($location): ?>
							<div class="reco-sale-location"
								style="display: flex; align-items: center; gap: 8px; color: #555; margin-top: 10px;">
					...
					<div class="reco-sale-specs">
						<div class="reco-sale-specs__item">
							<svg viewBox="0 0 24 24" width="28" height="28" fill="none" stroke="currentColor"
								stroke-width="1.5">
								<rect x="3" y="3" width="18" height="18" rx="2" /><text x="12" y="16" text-anchor="middle"
									font-size="8" fill="currentColor" stroke="none">m²</text>
							</svg>
						...
						<div class="reco-sale-specs__item">
							<svg viewBox="0 0 24 24" width="28" height="28" fill="none" stroke="currentColor"
								...
								<path d="M3 12V7a1 1 0 011-1h3a1 1 0 011 1v5" />
								<line x1="3" y1="18" x2="3" y2="21" />
								<line x1="21" y1="18" x2="21" y2="21" />
							</svg>
							<span><?php echo $bedrooms !== '' ? esc_html($bedrooms) . 'PN' : '—'; ?></span>
						</div>
						<div class="reco-sale-specs__divider"></div>
						<div class="reco-sale-specs__item">
							<svg viewBox="0 0 24 24" width="28" height="28" fill="none" stroke="currentColor"
								...
								<path d="M6 12V5a2 2 0 012-2h0a2 2 0 012 2v1" />
								<circle cx="8" cy="9" r="2" />
								<line x1="4" y1="19" x2="4" y2="22" />
								<line x1="20" y1="19" x2="20" y2="22" />
							</svg>
							<span><?php echo $bathrooms !== '' ? esc_html($bathrooms) . 'WC' : '—'; ?></span>
						</div>
					</div>
						...
						<div class="reco-sale-detail-table">
							<div class="reco-sale-detail-row">
								<div class="reco-sale-detail-cell">
									...
									<span
										class="reco-sale-detail-cell__value"><?php echo esc_html($date_published); ?></span>
								</div>
								<div class="reco-sale-detail-cell">
									<span class="reco-sale-detail-cell__icon">
										<svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor"
									...
									<span
										class="reco-sale-detail-cell__value"><?php echo esc_html($date_modified); ?></span>
								</div>
							</div>
							<div class="reco-sale-detail-row">
								<div class="reco-sale-detail-cell">
									...
									<span
										class="reco-sale-detail-cell__value"><?php echo $bedrooms !== '' ? esc_html($bedrooms) : '—'; ?></span>
								</div>
								<div class="reco-sale-detail-cell">
									<span class="reco-sale-detail-cell__icon">
										<svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor"
											stroke-width="1.5">
											<rect x="3" y="3" width="18" height="18" rx="2" /><text x="12" y="16"
												text-anchor="middle" font-size="7" fill="currentColor"
												stroke="none">m²</text>
										</svg>
									</span>
									<span class="reco-sale-detail-cell__label">Diện tích</span>
									<span
										class="reco-sale-detail-cell__value"><?php echo $area ? esc_html($area) . ' m²' : '—'; ?></span>
								</div>
							</div>
							<div class="reco-sale-detail-row">
								<div class="reco-sale-detail-cell">
									...
									<span
										class="reco-sale-detail-cell__value"><?php echo $bathrooms !== '' ? esc_html($bathrooms) : '—'; ?></span>
								</div>
								<div class="reco-sale-detail-cell">
									<span class="reco-sale-detail-cell__icon">
										<svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor"
									...
									<span
										class="reco-sale-detail-cell__value"><?php echo $direction_text ? esc_html($direction_text) : '—'; ?></span>
								</div>
							</div>
						</div>

						<?php if ($map_embed): ?>
							<h3 class="reco-sale-section-title" style="font-size: 1rem; margin-top: 32px; margin-bottom: 16px;">
								BẢN ĐỒ VỊ TRÍ</h3>
				...
				<aside class="reco-sale-sidebar">
					...
					<div class="reco-sale-price-box">
						<span class="reco-sale-price-box__label"><?php echo esc_html($price_box_label); ?></span>
		...
		if ($related_query->have_posts()):
			...
			<section class="reco-sale-related-slider" style="background-color: #f9f9f9; padding: 50px 0; margin-top: 20px;">
				<div class="reco-container">
