		...
		array(
			...
			'fields'                => array(
				...
				array(
					...
					'type'          => 'select',
					'instructions'  => 'Chọn bộ phận (để hiển thị badge màu tương ứng).',
					'choices'       => array(
					...
					'default_value' => 'Kinh doanh',
					'return_format' => 'value',
					'ui'            => 1,
					'wrapper'       => array( 'width' => 33 ),
				),
				array(
					'key'           => 'field_reco_job_experience',
					'label'         => 'Yêu cầu kinh nghiệm',
					'name'          => 'reco_job_experience',
					'type'          => 'text',
					'instructions'  => 'VD: Không yêu cầu kinh nghiệm',
					'default_value' => 'Không yêu cầu kinh nghiệm',
