	...
	acf_add_local_field_group(
		array(
			...
			'fields' => array(
				...
				array(
					'key' => 'field_reco_project_type_select',
					'label' => 'Loại bất động sản',
					'name' => 'reco_project_type',
					'type' => 'taxonomy',
					...
					'save_terms' => 1,
					'load_terms' => 1,
					'instructions' => 'Chọn phân khúc hoặc loại hình của dự án.',
					'return_format' => 'object',
					'wrapper' => array('width' => 50),
				),
				array(
					'key' => 'field_reco_project_province',
					'label' => 'Tỉnh/Thành phố',
					'name' => 'reco_project_province',
					'type' => 'select',
				...
				array(
					'key' => 'field_reco_project_commune',
					'label' => 'Phường/Xã',
					'name' => 'reco_project_commune',
					'type' => 'select',
				...
				array(
					...
					'instructions' => 'Chọn tình trạng mở bán hiện tại của dự án.',
					'return_format' => 'value',
					'ui' => 1,
				...
				array(
					...
					'type' => 'number',
					'instructions' => 'Để trống nếu giá là Thỏa thuận.',
				...
				array(
					...
					'type' => 'text',
					'instructions' => 'Số điện thoại liên hệ nhanh (nếu có).',
